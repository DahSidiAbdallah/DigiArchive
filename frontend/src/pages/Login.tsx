    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        <div className="bg-white py-8 px-6 shadow rounded-lg sm:px-10">
          <h2 className="mb-6 text-center text-3xl font-extrabold text-gray-900">Connexion à votre compte</h2>
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="flex items-center justify-between">
              <Link to="/forgot-password" className="text-sm font-medium text-primary-600 hover:text-primary-800">Mot de passe oublié ?</Link>
            </div>
            <div>
              <button
                type="submit"
        ...
        <div className="text-center mt-6">
          <p className="text-sm text-gray-500">
            ...
            <Link to="/register" className="font-semibold text-primary-600 hover:text-primary-800">Inscrivez-vous ici</Link>
          </p>
        </div>
      </div>
    </div>
